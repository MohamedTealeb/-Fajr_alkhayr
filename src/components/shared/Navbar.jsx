  ...
  return (
    <header className="bg-gradient-to-l from-amber-700 via-amber-600 to-amber-400 text-white px-4 md:px-10 py-2 flex items-center justify-between shadow-lg border-b border-amber-200/40 sticky top-0 z-50 backdrop-blur-md">
      ...
      <Link href="/home" className="flex items-center gap-2">
        <span className="rounded-full bg-white/80 shadow-lg p-1 md:p-2 flex items-center justify-center border-2 border-amber-300">
          <Image src="/logohedar.webp" alt="Logo" width={56} height={56} className="rounded-full" />
        </span>
        <span className="hidden md:inline text-2xl font-extrabold tracking-tight text-amber-900 drop-shadow">فجر الخير</span>
      </Link>
